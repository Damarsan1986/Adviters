<%@ Page Title="Monedas" Language="C#" MasterPageFile="~/container.Master" AutoEventWireup="true" CodeBehind="monedas.aspx.cs" Inherits="FE.monedas" EnableEventValidation="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageBody" runat="server">
        ...
        <div id="fh5co-main-sistema">
            <div id="titulo-modulo">
                <div class="container">
                    <asp:Label ID="lblModuloMonedas" runat="server"  CssClass="modulo-label" Text="ADMINISTRACION DE MONEDAS" />
                </div>
            </div>
...
<%--                                <div class="col-md-2 text-right">
                            ...
                            <div class="row">
                                <div class="col-md-3 text-right">
                                    <asp:RegularExpressionValidator ID="REV_CP" runat="server" ControlToValidate="txtCP" ForeColor="Red" Font-Bold="true" ErrorMessage="[a-z/0-9] --> "  ValidationExpression="^[a-zA-Z\s0-9]{1,10}$" ValidationGroup="formato" />
