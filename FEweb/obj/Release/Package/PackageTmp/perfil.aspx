...
<asp:Content ID="Content2" ContentPlaceHolderID="PageBody" runat="server">
    <div id="fh5co-main-sistema">
        ...
        <div class="row">
            ...
            <asp:LinkButton ID="btnGuardar" runat="server" CssClass="btn btn-primary btn-mid" ValidationGroup="formato" CausesValidation="true" Text="Guardar" OnClick="btnGuardar_Click"><span class="glyphicon glyphicon-save"></span>&nbsp;Guardar</asp:LinkButton>
