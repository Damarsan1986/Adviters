<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="FE.login" %>
						...
						<div class="col-md-8 col-md-offset-2">
							<div class="fh5co-hero-wrap">
								<div class="fh5co-hero-intro-login">
										<h2>Acceso Seguro al Sistema<span></span></h2>
										<%--<h1>Ingrese sus datos para acceder al sistemA</h1>--%>
                                        <p></p>
                                        <div class="row fh5co-feature-2-login">
                                            <div class="col-md-5 fh5co-feature-item">
								                <p class="text-right fh5co-feature-description">Usuario:</p>
								                <p class="text-right fh5co-feature-description">Contraseña:</p>
							                </div>
							                <div class="col-md-5 fh5co-feature-item">
                                        ...
                                        <br />
                                        <asp:Label ID="lblNewPass" runat="server" CssClass="fh5co-feature-label" Text="<a href = 'newpass.aspx'>Olvidó su Contraseña?</a>" />
