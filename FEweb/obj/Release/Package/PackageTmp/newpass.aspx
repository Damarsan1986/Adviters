<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="newpass.aspx.cs" Inherits="FE.newpass" %>
						...
						<div class="col-md-8 col-md-offset-2">
							<div class="fh5co-hero-wrap">
								<div class="fh5co-hero-intro-login">
										<h2>Recupero de Contraseña<span></span></h2>
                                        <p></p>
                                        <div class="row fh5co-feature-2-login">
                                            <div class="col-md-5 fh5co-feature-item">
                                                <p class="text-right fh5co-feature-description"><asp:Label ID="lblUsuario" runat="server" Text="Usuario:"></asp:Label></p>
								                <p class="text-right fh5co-feature-description"><asp:Label ID="lblEmail" runat="server" Text="Email:"></asp:Label></p>
							                </div>
							                <div class="col-md-5 fh5co-feature-item">
								                <p class="text-left fh5co-feature-textbox"><asp:TextBox ID="txtIdUsuario" runat="server"></asp:TextBox> </p>
                                                <p class="text-left fh5co-feature-textbox"><asp:TextBox ID="txtemail" runat="server"></asp:TextBox> </p>
							                </div>
